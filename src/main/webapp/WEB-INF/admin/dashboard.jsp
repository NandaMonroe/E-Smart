    ...
    <div class="center">
        ...
        <div class="d-flex mb-5">
            ...
            <div class="box-link card cursor">
                <a href="/admin/add/department" class="text-white"><h4>Add Department</h4></a>
            </div>

            <div class="box-link card cursor">
                <a href="/admin/add/employee" class="text-white"><h4>Add Employeee</h4></a>
            </div>

            <div class="box-link card cursor">
                <a href="#" class="text-white"><h4>Update Schedule</h4></a>
            </div>
